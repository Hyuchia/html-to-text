(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["html-to-text"] = factory();
	else
		root["HTMLToText"] = factory();
})(window, function() {
...
var striptags = __webpack_require__(0);
...
// CONCATENATED MODULE: ./src/entities.js
/* harmony default export */ var entities = ({
  "&Tab;": "\t",
  "&NewLine;": "\n",
  "&excl;": "!",
  //"&quot;": "\"",
...
const blocks = ['p', 'div', 'br', 'hr', 'title', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'ol', 'ul', 'li', 'pre', 'table', 'th', 'td', 'blockquote', 'header', 'footer', 'nav', 'section', 'summary', 'aside', 'article', 'address', 'code', 'img'];
const unparsable = ['audio', 'iframe', 'map', 'progress', 'track', 'meter', 'object', 'svg', 'wbr', 'video', 'webview', 'dialog', 'canvas'];
const silent = ['ol', 'ul', 'span'];
...
const removeAllNonTagsToBreakOn = html => striptags_default()(html, blocks);

const convertTagsToBreak = html => striptags_default()(html, [], '\n');

const removeIndentation = html => html.replace(/(^\t+)/gm, '');

const htmlToText = compose(removeIndentation, replaceSensitiveCharacters, convertTagsToBreak, removeAllNonTagsToBreakOn, //removeExtraBreakLines,
...
/* harmony default export */ var src = __webpack_exports__["default"] = (htmlToText);
